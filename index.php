...
?>
    <div class='row'>
        ...
        <div class='col-md-12'>
            <ul class='nav justify-content-center'>
                <li id='portfolio' class='nav-item'><a id='portfolioLink' class='nav-link text-danger' href='index.php'><i class='fa-solid fa-bars'></i> Portfolio</a></li>
                <li id='about' class='nav-item'><a id='aboutLink' class='nav-link text-white' href='about.php'><i class='fa-solid fa-user'></i> About me</a></li>
    ...
    <div class='row'>
        <div class="col-md-12 py-3 d-flex flex-wrap">
            <div class="card bg-dark text-white m-1 shadow" style="width: 18rem;">
